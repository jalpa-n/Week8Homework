...
public class P16_Point {
    ...
    public P16_Point()       //Constructor with no parameter
    {

    }
    public P16_Point(int x, int y)      //constructor with parameter
    {
        this.x = x;
        this.y = y;
    }

    public int getX() {      //Instance method with return type

        return x;
    }

    public int getY()        //Instance method with return type
    {
        return y;
    }
    ...
    public double distance(double a,double b)
    {
        ...
        double x2=b;
        double dist=0;
        dist=Math.sqrt((x1-x)*(x1-x)+(-y)*(x2-y));
return dist;
    }
//Main Method
